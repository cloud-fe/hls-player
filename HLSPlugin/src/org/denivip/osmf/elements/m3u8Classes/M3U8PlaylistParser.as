package org.denivip.osmf.elements.m3u8Classes
{
	...
	import org.denivip.osmf.net.httpstreaming.hls.HTTPStreamingHLSIndexHandler;
	...
	public class M3U8PlaylistParser extends EventDispatcher
	{
		public function M3U8PlaylistParser(){
			...
			HTTPStreamingHLSIndexHandler.errorFunc = errorFunc;
			// nothing todo here...
		}
		...
		public function parse(value:String, baseResource:URLResource):Boolean{
